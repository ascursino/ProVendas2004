...
Begin VB.Form FrmCaixa_AReceber_Inc 
   Caption         =   "Inclusão de Contas A Receber"
   ClientHeight    =   5745
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   3945
   ...
   EndProperty
   Icon            =   "FrmCaixa_AReceber_Inc.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   5745
   ScaleWidth      =   3945
   Begin VB.Frame FraBotaoCli 
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   240
         OleObjectBlob   =   "FrmCaixa_AReceber_Inc.frx":0CCA
         Top             =   120
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox CboTipo 
         Height          =   315
         ItemData        =   "FrmCaixa_AReceber_Inc.frx":0EFE
         Left            =   1320
         List            =   "FrmCaixa_AReceber_Inc.frx":0F0E
         TabIndex        =   0
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCaixa_AReceber_Inc.frx":0F59
         TabIndex        =   11
         Top             =   240
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCaixa_AReceber_Inc.frx":0FC7
         TabIndex        =   12
         Top             =   720
         Width           =   1215
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCaixa_AReceber_Inc.frx":1035
         TabIndex        =   13
         Top             =   1200
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCaixa_AReceber_Inc.frx":1099
         TabIndex        =   14
         Top             =   1680
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel42 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCaixa_AReceber_Inc.frx":1105
         TabIndex        =   15
         Top             =   3840
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel43 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCaixa_AReceber_Inc.frx":1169
         TabIndex        =   16
         Top             =   4200
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCaixa_AReceber_Inc.frx":11D5
         TabIndex        =   17
         Top             =   3480
         Width           =   3495
      End
   End
End
Attribute VB_Name = "FrmCaixa_AReceber_Inc"
...
Private Sub CmdOK_Click()
    ...
    Else
        ...
        StrSql = "Select * From tb_ContaReceber"
        ...
        End If
        If TxtCheque.Text = "" And TxtDigito.Text = "" Then
            RecReceb("NumCheque") = ""
        Else
            RecReceb("NumCheque") = TxtCheque.Text & "-" & TxtDigito.Text
        End If
        RecReceb("Recebido") = "não"
        RecReceb.Update
        ...
        VPStrBox = MsgBox("Recebimento cadastrado.", vbInformation, "Pró Vendas 2004 - Informação")
...
Private Sub Form_Resize()
  FrmCaixa_AReceber_Inc.Left = (MDIPrincipal.Width / 2) - (FrmCaixa_AReceber_Inc.Width / 2)
  FrmCaixa_AReceber_Inc.Top = (MDIPrincipal.Height / 3) - (FrmCaixa_AReceber_Inc.Height / 3)
End Sub
