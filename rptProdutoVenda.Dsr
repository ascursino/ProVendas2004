VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptProdutoVenda 
   Bindings        =   "rptProdutoVenda.dsx":0000
   Caption         =   "Relatório de Produto por Preço de Venda (visualização)"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15240
   Icon            =   "rptProdutoVenda.dsx":001B
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item5 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Preço venda unitário"
      EndProperty
      ItemType6       =   3
      ...
      BeginProperty Item8 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Relatório de Produto por Preço de Venda"
         Alignment       =   1
      EndProperty
      ItemType9       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptProdutoVenda"
