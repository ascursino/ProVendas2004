   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item6 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Sistema Integrado de Vendas"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode4    =   8
...
Private Sub DataReport_Initialize()
    ...
    Desconecta
    'MsgBox ("fim da conexão da logo")
    Screen.MousePointer = vbNormal
    
End Sub

Private Sub DataReport_Terminate()
    'MsgBox ("começo da desconexão da logo")
    Conecta
    vgCon.Execute "DELETE FROM tb_Auxiliar"
    Desconecta
    'MsgBox ("fim da desconexão da logo")
End Sub
