...
Begin VB.Form FrmCrediarista_Inc 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   255
         Left            =   4080
         OleObjectBlob   =   "FrmCrediarista_Inc.frx":105A
         TabIndex        =   25
         Top             =   2640
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel11 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCrediarista_Inc.frx":10C8
         TabIndex        =   26
         Top             =   3120
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel12 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCrediarista_Inc.frx":112C
         TabIndex        =   27
         Top             =   3600
         Width           =   1335
      End
   ...
   Begin VB.Frame FraBotaoCli 
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   2640
         OleObjectBlob   =   "FrmCrediarista_Inc.frx":119A
         Top             =   120
      End
...
Private Sub CmdOK_Click()
    ...
    Else
        ...
        Else
            ...
            VPStrBox = MsgBox("Crediarista cadastrado.", vbInformation, "Pró Vendas 2004 - Informação")
