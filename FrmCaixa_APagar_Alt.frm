...
Private Sub Form_Load()
    ...
    CboTipo.Text = VerificaNulo(RecPag!tipo)
    TxtDtVenc.Text = FormataData(RecPag!vencimento)
    TxtValor.Text = FormataMoeda(VerificaNulo(RecPag!valor))
    TxtDescr.Text = VerificaNulo(RecPag!Descricao)
