...
Begin VB.Form FrmFornecedor_Inc 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":0CCA
         TabIndex        =   19
         Top             =   720
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":0D38
         TabIndex        =   20
         Top             =   1200
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":0DA2
         TabIndex        =   21
         Top             =   1680
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":0E08
         TabIndex        =   22
         Top             =   2160
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":0E6E
         TabIndex        =   23
         Top             =   2640
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":0ED0
         TabIndex        =   24
         Top             =   4080
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   255
         Left            =   3840
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":0F34
         TabIndex        =   25
         Top             =   3600
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   3840
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":0F9C
         TabIndex        =   26
         Top             =   1680
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel9 
         Height          =   255
         Left            =   3840
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":0FFC
         TabIndex        =   27
         Top             =   2160
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   255
         Left            =   3840
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":1062
         TabIndex        =   28
         Top             =   2640
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel11 
         Height          =   255
         Left            =   3840
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":10D0
         TabIndex        =   29
         Top             =   3120
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel12 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":1138
         TabIndex        =   30
         Top             =   4440
         Width           =   1455
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel13 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":11A6
         TabIndex        =   31
         Top             =   240
         Width           =   1935
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel14 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":121E
         TabIndex        =   32
         Top             =   3600
         Width           =   495
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel15 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":127E
         TabIndex        =   33
         Top             =   3120
         Width           =   975
      End
   ...
   Begin VB.Frame FraBotaoCli 
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   960
         OleObjectBlob   =   "FrmFornecedor_Inc.frx":12EC
         Top             =   120
      End
...
Private Sub CmdFechar_Click()
    ...
    If VGStrIncluirProd = "prod" Then
        VGStrIncluirProd = ""
        Unload Me
        FrmProduto_Inc.Enabled = True
        
    ElseIf VGStrIncluirProd = "altprod" Then
        VGStrIncluirProd = ""
        Unload Me
        FrmProduto_Alt.Enabled = True
    End If
...
Private Sub CmdOK_Click()
    ...
    Else
        ...
        StrSql = "SELECT Max(CodForn) as CodForn FROM tb_Fornecedor"
        RecForn.Open StrSql, vgCon, 1, 3
        
        VGStrTransfDados = TxtNome.Text & "                                                                                                 " & RecForn!CodForn
                    
        Desconecta
        
        VPStrBox = MsgBox("Fornecedor cadastrado.", vbInformation, "Pró Vendas 2004 - Informação")
        ...
        If VGStrIncluirProd = "prod" Then
            ...
            FrmProduto_Inc.CboForn.Text = VGStrTransfDados
            VGStrTransfDados = ""
            FrmProduto_Inc.Enabled = True
        ...
        ElseIf VGStrIncluirProd = "altprod" Then
            VGStrIncluirProd = ""
            Unload Me
            FrmProduto_Alt.MontaCboForn
            FrmProduto_Alt.CboForn.Text = VGStrTransfDados
            VGStrTransfDados = ""
            FrmProduto_Alt.Enabled = True
        End If
    End If
...
Private Sub TxtCnpj_KeyPress(KeyAscii As Integer)
    '=== Só aceita números, - e / ===
    If (KeyAscii < 47 Or KeyAscii > 57) And KeyAscii <> 8 And KeyAscii <> 13 And KeyAscii <> 45 Then
        KeyAscii = 0
    End If
End Sub
