...
Begin VB.Form FrmCliente_Inc 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   255
         Left            =   3840
         OleObjectBlob   =   "FrmCliente_Inc.frx":1064
         TabIndex        =   28
         Top             =   3120
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel11 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":10CC
         TabIndex        =   29
         Top             =   4080
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel12 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":1130
         TabIndex        =   30
         Top             =   4560
         Width           =   1335
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel13 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":119E
         TabIndex        =   31
         Top             =   2640
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel14 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":1200
         TabIndex        =   32
         Top             =   3600
         Width           =   495
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel15 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":1260
         TabIndex        =   33
         Top             =   3120
         Width           =   1095
      End
   ...
   Begin VB.Frame FraBotaoCli 
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   360
         OleObjectBlob   =   "FrmCliente_Inc.frx":12CE
         Top             =   120
      End
   End
End
...
Private Sub CmdOK_Click()
    ...
    Else
        ...
        RecCli.AddNew
        RecCli("DtCad") = FormataDataUS(Date)
        'RecCli("Nome") = VGCrypto.CriptSenha(TxtNome.Text)
        ...
        VPStrBox = MsgBox("Cliente cadastrado.", vbInformation, "Pró Vendas 2004 - Informação")
