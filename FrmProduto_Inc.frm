...
Begin VB.Form FrmProduto_Inc 
   ...
   Begin VB.Frame FraArmacao 
      ...
      Begin VB.ComboBox CboMoeda 
         Height          =   315
         ItemData        =   "FrmProduto_Inc.frx":0CCA
         Left            =   5520
         List            =   "FrmProduto_Inc.frx":0CD4
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmProduto_Inc.frx":0CE5
         TabIndex        =   13
         Top             =   360
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmProduto_Inc.frx":0D53
         TabIndex        =   14
         Top             =   1320
         Width           =   1215
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   3720
         OleObjectBlob   =   "FrmProduto_Inc.frx":0DC5
         TabIndex        =   15
         Top             =   2760
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmProduto_Inc.frx":0E29
         TabIndex        =   16
         Top             =   840
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmProduto_Inc.frx":0E91
         TabIndex        =   17
         Top             =   1800
         Width           =   1455
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   3720
         OleObjectBlob   =   "FrmProduto_Inc.frx":0F07
         TabIndex        =   18
         Top             =   2280
         Width           =   1815
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmProduto_Inc.frx":1001
         TabIndex        =   20
         Top             =   2760
         Width           =   1815
      End
   ...
   Begin VB.Frame FraBotaoCli 
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   1320
         OleObjectBlob   =   "FrmProduto_Inc.frx":1081
         Top             =   240
      End
...
Private Sub CmdOK_Click()
    ...
    Else
        ...
        StrSql = "Select * from tb_Produto where NomeProd='" & TxtProd.Text & "'"
        RecProd.Open StrSql, vgCon, 1, 3
        
        If Not RecProd.EOF Then
            VPStrBox = MsgBox("Já existe um produto cadastrado com esse nome.", vbInformation, "Pró Vendas 2004 - Informação")
            Desconecta
            TxtProd.SetFocus
        Else
            RecProd.AddNew
            ...
            VPStrResponse = MsgBox("Deseja incluir informações deste produto no estoque agora?", vbYesNo, "Pró Vendas 2004 - Informação")
