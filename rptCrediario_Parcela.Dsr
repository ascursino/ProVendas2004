VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptCrediario_Parcela 
   Bindings        =   "rptCrediario_Parcela.dsx":0000
   Caption         =   "Relatório de Crediário (visualização)"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   14070
   Icon            =   "rptCrediario_Parcela.dsx":001B
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item5 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Pró Vendas 2004"
         Alignment       =   2
      EndProperty
      ItemType6       =   3
      BeginProperty Item6 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Sistema Integrado Vendas"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode4    =   8
   ...
   EndProperty
End
Attribute VB_Name = "rptCrediario_Parcela"
...
Private Sub DataReport_Initialize()
    ...
    DtEnv_Vendas.Commands.Item(1).CommandText = "Select * from tb_Auxiliar order by Campo15"
    ...
    Dim RecLogo As New ADODB.Recordset
    Conecta
    
    StrSql = "Select LogoInfo,LogoEmpresa From tb_RelatorioImagem"
    RecLogo.Open StrSql, vgCon, 1, 3
    
    If IsNull(RecLogo!LogoEmpresa) = True Or RecLogo!LogoEmpresa = "" Then
        Set Me.Sections.Item(2).Controls.Item("ImgLogo").Picture = LoadPicture(App.Path & "\" & RecLogo!LogoInfo)
    Else
        Set Me.Sections.Item(2).Controls.Item("ImgLogo").Picture = LoadPicture(RecLogo!LogoEmpresa)
    End If
